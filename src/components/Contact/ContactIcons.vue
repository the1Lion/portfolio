...
<template>
    <div class="flex py-2">
      ...
      <div class="text-left ml-2.5"><p class="text-xs text-[#44566C]">Phone</p>
    ...
    <div class="flex py-2.5 ">
      <span
        class="flex-shrink-0 text-[#6AB5B9]">
        <svg stroke="currentColor"
             fill="currentColor"
             stroke-width="0"
             viewBox="0 0 384 512"
      ...
      <div class="text-left ml-2.5"><p class="text-xs text-[#44566C]">Location</p>
        <p class="break-all">{{
    ...
    <div class="flex py-2.5 ">
      ...
      <div class="text-left ml-2.5"><p class="text-xs text-[#44566C]">Email</p>
        <p class="break-all"><a class="hover:text-[#FA5252] duration-300 transition"
